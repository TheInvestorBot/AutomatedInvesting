...
class MakeMoola:
    ...
    def update(self):
        ...
        i = 1
        while i <= 50 :
            self.ticker_list.append(driver.find_elements_by_xpath("/html/body/div[2]/div[4]/div[2]/div/div/div[2]/div[2]/div[4]/table/tbody/tr[" + str(i) + "]/td[1]/div/div[2]/a")[0].text)
            i += 1
